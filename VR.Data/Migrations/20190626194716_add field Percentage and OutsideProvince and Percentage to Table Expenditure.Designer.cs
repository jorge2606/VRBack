...
namespace VR.Data.Migrations
{
    ...
    [Migration("20190626194716_add field Percentage and OutsideProvince and Percentage to Table Expenditure")]
    partial class addfieldPercentageandOutsideProvinceandPercentagetoTableExpenditure
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("VR.Data.Model.ApproveOfAuthority_Solicitation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();

                    b.Property<Guid>("AprApproveOfAuthorityThatOrderCommissionId");

                    b.Property<Guid>("SolicitationSubsidyId");

                    b.HasKey("Id");

                    b.HasIndex("AprApproveOfAuthorityThatOrderCommissionId");

                    b.HasIndex("SolicitationSubsidyId");

                    b.ToTable("ApproveOfAuthoritySolicitations");
                });

            modelBuilder.Entity("VR.Data.Model.ApproveOfAuthorityThatOrderCommission", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.Property<int>("OrderReport");

                    b.HasKey("Id");

                    b.ToTable("ApproveOfAuthorityThatOrderCommissions");
                });
            ...
            modelBuilder.Entity("VR.Data.Model.Destiny", b =>
                {
                    ...
                    b.Property<int?>("AccountedForDays");
                    ...
                    b.Property<int>("DaysHolidays");

                    b.Property<int>("DaysPay");

                    b.Property<int>("DaysWeekEnd");
            ...
            modelBuilder.Entity("VR.Data.Model.Expenditure", b =>
                {
                    ...
                    b.Property<decimal?>("AccountedForAmount");
                    ...
                    b.Property<DateTime>("SupportingDate");
            ...
            modelBuilder.Entity("VR.Data.Model.ExpenditureType", b =>
                {
                    ...
                    b.Property<bool>("OutsideProvince");
            ...
            modelBuilder.Entity("VR.Data.Model.LegalRuling", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("VR.Data.Model.Observation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("VR.Data.Model.ApproveOfAuthority_Solicitation", b =>
                {
                    b.HasOne("VR.Data.Model.ApproveOfAuthorityThatOrderCommission", "AprApproveOfAuthorityThatOrderCommission")
                        .WithMany()
                        .HasForeignKey("AprApproveOfAuthorityThatOrderCommissionId")
                        .OnDelete(DeleteBehavior.Cascade);
            ...
            modelBuilder.Entity("VR.Data.Model.File", b =>
                {
                    b.HasOne("VR.Data.Model.Expenditure", "Expenditure")
                        .WithMany("Images")
            ...
            modelBuilder.Entity("VR.Data.Model.SolicitationSubsidy", b =>
                {
                    b.HasOne("VR.Data.Model.LegalRuling", "LegalRuling")
                        .WithMany()
                        .HasForeignKey("LegalRulingId");
